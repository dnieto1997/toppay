 ...
 const Dashboard1 = () => {
          ...
          const  todayMoneyin = async () => {
           ...
           const res = await fetch('http://129.80.238.214:3000/api/dashboard/todaymoneyin', {
            ...
            const  todaysTransactionin = async () => {
             ...
             const res = await fetch('http://129.80.238.214:3000/api/dashboard/todaystransactionin', {
              method: 'GET',
              headers: {
              ...
              const  todaysTransactionerrorin = async () => {
               ...
               const res = await fetch('http://129.80.238.214:3000/api/dashboard/todaystransactionerrorin', {
                method: 'GET',
                headers: {
                ...
                const  todayMoneyout = async () => {
                 ...
                 const res = await fetch('http://129.80.238.214:3000/api/dashboard/todaymoneyout', {
                  method: 'GET',
                  headers: {
                  ...
                  const  todaysTransactionout = async () => {
                   ...
                   const res = await fetch('http://129.80.238.214:3000/api/dashboard/todaystransactionout', {
                    method: 'GET',
                    headers: {
    ...
    <Image source={require('../assets/img/setting.png')} style={styles.imagen}/>
     ...
     <View style={{marginLeft:10}}>
      ...
      <Text style={styles.texto2} >{formatearCantidad(todaymoneyin)} </Text>
      </View>
     </View>
     </View>
     </View>
    ...
    <Image source={require('../assets/img/cash.png')} style={styles.imagen}/>
     ...
     <View style={{marginLeft:10}}>
      ...
      <Text style={styles.texto2}>{todaystransactionin} (COP) <Text style={{color:'green'}}>Success</Text></Text>
      <Text style={styles.texto2}>{todaystransactionerrorin} (COP) <Text style={{color:'red'}}>Pending</Text></Text>
      </View>
     </View>
     </View>
     </View>
    ...
    <Text style={[styles.texto1,styles.texto0]}>Today's Money Transaction Cash Out</Text>
   
      
      <Text style={styles.texto2} >{formatearCantidad(todaymoneyout)} </Text>
      </View>
     </View>
     </View>
     </View>
    ...
    <Image source={require('../assets/img/setting.png')} style={styles.imagen}/>
     ...
     <View style={{marginLeft:10}}>
      ...
      <Text style={styles.texto2}>{todaystransactionout} (COP) <Text style={{color:'green'}}>Success</Text></Text>
